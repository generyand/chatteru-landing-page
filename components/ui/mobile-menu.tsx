      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="#0" className="flex justify-center w-full py-2 font-medium text-gray-600 hover:text-gray-900" onClick={() => setMobileNavOpen(false)}>About</Link>
            </li>
            <li>
              <Link href="#0" className="flex justify-center w-full py-2 font-medium text-gray-600 hover:text-gray-900" onClick={() => setMobileNavOpen(false)}>Features</Link>
            </li>
            <li>
              <Link href="#0" className="w-full my-2 text-gray-200 bg-gray-900 btn-sm hover:bg-gray-800" onClick={() => setMobileNavOpen(false)}>
