      ...
      <div className="relative max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            <h2 className="mb-4 h2">Explore What Techs are Used</h2>
            <p className="text-xl text-gray-600">
              Chatteru is built using the following tools:
            </p>
          </div>
          ...
          <div className="grid items-start max-w-sm gap-6 mx-auto md:grid-cols-2 lg:grid-cols-3 md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl outline outline-1">
              {/* <svg
              ...
              <p className="text-center text-gray-600">
                Concise, safe, interoperable, and tool-friendly JVM language.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl outline outline-1">
              ...
              <p className="text-center text-gray-600">
                Unified system combining theory, resources, and tools for visual
                design.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl outline outline-1">
              ...
              <p className="text-center text-gray-600">
                Automatic Speech Recognition system for transcribing spoken
                language.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl outline outline-1">
              ...
              <p className="text-center text-gray-600">
                API for generating human-like text using AI models.
              </p>
            </div>
